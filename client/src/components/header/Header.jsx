...
import { faBed, faCar, faPlane, faCalendarDays, faPerson} from "@fortawesome/free-solid-svg-icons";
    ...
    return (
        <div className="header">
            ...
            <div className="headerList">
                <div className="headerListItem bord">
            ...
            { type !== "list" &&
            <>
            <h1 className="headerTitle">Effortless Hotel Bookings Tailored Just for You.</h1>
            <p className="headerDesc">
            "Unlock your ideal escape with our hotel booking website,where comfort meets convenience. Effortless bookings, tailored to you."
            </p>
